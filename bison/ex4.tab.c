...
{
  "\"end of file\"", "error", "\"invalid token\"", "INTCONST", "PLUS",
  "MINUS", "ASTERISK", "SLASH", "LPAREN", "RPAREN", "UMINUS", "$accept",
  "expr", YY_NULLPTR
};
...
#line 1079 "ex4.tab.c"
  ...
  case 4: /* expr: expr ASTERISK expr  */
#line 27 "ex4.y"
                         { printf("Multiplication\n"); }
#line 1085 "ex4.tab.c"
    break;

  case 5: /* expr: expr SLASH expr  */
#line 28 "ex4.y"
                      { printf("Division\n"); }
#line 1091 "ex4.tab.c"
    break;
